...
class SegCuentas extends Component {
    ...
    pedidosPendientesFactura(){   
        ...
        fetch(`${process.env.REACT_APP_URL_PRODUCCION}/api/actualizarpedidossinpago`, requestOptions)
          .then(response => response.json())
          .then(data => {   
                this.setState({
                    dataOrdenesMongo: data.datos
    ...
    pedidosFacturados(){   
        ...
        fetch(`${process.env.REACT_APP_URL_PRODUCCION}/api/actualizarpedidosconpago`, requestOptions)
          .then(response => response.json())
          .then(data => {               
                this.setState({
                    dataOrdenesMongo: data.datos
    ...
    pedidosTodos(){
        ...
        fetch(`${process.env.REACT_APP_URL_PRODUCCION}/api/pedidos`, requestOptions)
          .then(response => response.json())
          .then(data => {
                //console.log(data.datos)
                this.setState({
    ...
    buscarMesa(){        
        ...
        fetch(`${process.env.REACT_APP_URL_PRODUCCION}/api/buscarmesapedidos/` + this.state.mesaFiltro, requestOptions)
            .then(response => response.json())
            .then(data => {
                //********************************
                    let nuevoPedido = [];
    ...
    indexOrdenes(index){
        ...
        //Actualizamos en DB
            ...
            fetch(`${process.env.REACT_APP_URL_PRODUCCION}/api/actualizarpedidos/` + index, requestOptions)
                .then(response => response.json())
                .then(data => {
                        //console.log(data.datos)              
                    })
