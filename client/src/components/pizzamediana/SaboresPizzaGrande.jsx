...
class SaboresPizzaGrande extends Component {
    constructor(props){
        super(props);    
        this.state={
            estado: 'inicio',
    ...
    render(){
        const opcionPizza = () => {
            switch(this.state.estado) {
                ...
                case "combinada": return (<CombinadaIngredientesGrande combinada={this.state.combinada} comDosTresIngre={this.state.comDosTresIngredientes} porcion={this.props.porcion} atrasMenuPersonal={this.atrasPersonal} atrasMenuPersonalSabor={this.atrasPersonalSabor} cuentamitad={this.agregaraCuentaMitadCombinada}/>)
                }
            }
        return(
            <div>{ opcionPizza() }</div>
...
export default SaboresPizzaGrande