...
import '../../../App.css';
import CombinadaIngredientesPantalon from './CombinadaIngredientesPancook';

class SaborePizzaPancook extends Component {
    constructor(props){
        super(props);    
        this.state={
            estado: 'inicio',
        ...
        const opcionPizza = () => {
            switch(this.state.estado) {
                case "inicio": return(
                    <div>
                    <div>
                        <p style={{marginLeft: '10px'}}>Porcion: {this.props.porcion}</p>
                    </div>
                ...
                case "combinada": return (<CombinadaIngredientesPantalon combinada={this.state.combinada} comDosTresIngre={this.state.comDosTresIngredientes} porcion={this.props.porcion} atrasMenuPersonal={this.atrasPersonal} atrasMenuPersonalSabor={this.atrasPersonalSabor} cuentamitad={this.agregaraCuentaMitadCombinada}/>)
                }
            }
        return(
            <div>{ opcionPizza() }</div>
...
export default SaborePizzaPancook