  ...
  toggleModalAceptar = () => {
    ...
    if (contPersonales[0] === null) {
      ...
      pedidoPizza = {
        ...
        costo_pantalon: parseInt(process.env.REACT_APP_PIZZA_PANTALON_COSTO) - this.state.ajusteCostoPromo,
      ...
      localStorage.setItem(
        `Pedido_Pantalon_${contPersonales[0].Numero}`,
