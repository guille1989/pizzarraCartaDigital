  ...
  toggleModalAceptar = () => {
    ...
    if (contPersonales[0] === null) {
      ...
      pedidoPizza = {
        ...
        costo_pancook: parseInt(process.env.REACT_APP_PIZZA_PANCOOK_COSTO - this.state.ajusteCostoPromo),
      ...
      localStorage.setItem(
        `Pedido_Pancook_${contPersonales[0].Numero}`,
